package app.application.sdk_base_lib.util.entry;


import app.application.sdk_base_lib.util.ConvertUtils;

import static app.application.sdk_base_lib.util.entry.CRC_CCITT.Type.TYPE_Kermit;
...
public class CRC_CCITT {
    ...
    private static String getCrcCheck_Kermit(byte[] data) {
        ...
        return ConvertUtils.bytes2HexString(crcByte);
    }
