...
public class AppUtils {
    ...
    public static boolean installAppSilent(String filePath) {
        ...
        ShellUtils.CommandResult commandResult = ShellUtils.execCmd(command, !isSystemApp(BaseApplication.getContext()), true);
    ...
    public static boolean isAppForeground(Context context, String packageName) {
        return !TextUtils.isEmpty(packageName) && packageName.equals(ProcessUtils.getForegroundProcessName());
    }
