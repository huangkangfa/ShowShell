    ...
    public static String getForegroundProcessName() {
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (list.size() > 0) {// 有"有权查看使用权限的应用"选项
                try {
                    ApplicationInfo info = packageManager.getApplicationInfo(BaseApplication.getContext().getPackageName(), 0);
                    AppOpsManager aom = (AppOpsManager) BaseApplication.getContext().getSystemService(Context.APP_OPS_SERVICE);
                    ...
                    UsageStatsManager usageStatsManager = (UsageStatsManager) BaseApplication.getContext().getSystemService(Context.USAGE_STATS_SERVICE);
